  ...
  <div class="min-h-screen bg-neutral-50 dark:bg-primary-900">
    ...
    <header class="bg-white dark:bg-primary shadow-md">
      <div class="w-[92%] mx-auto px-4 py-4 sm:px-6 sm:py-6">
        <div class="flex justify-between items-center">
          <h1
            class="text-lg sm:text-xl md:text-2xl font-extrabold text-neutral-900 dark:text-white"
          >
            Where in the world?
          </h1>
          <ThemeToggle />
    ...
    <main class="w-[92%] mx-auto px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div
        ...
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-12 lg:gap-16"
      >
        <CountryCard
